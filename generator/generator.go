...
func (d *FileDescriptor) goFileName(pathType pathType) string {
	...
	name += fmt.Sprintf(".pb.%s.go", toolName)
...
// GetImport returns the package with the given import path.
func (g *Generator) GetImport() map[GoImportPath]bool {
	return g.addedImports
}
...
func (g *Generator) generateHeader() {
	g.P("// Code generated by ", g.toolName(), ". DO NOT EDIT.")
